...
function notificationIcon({props}) {
  return (
    <>
    {/* On */}
    <svg width="30px" className={`${props.notifyOn}`} height="30px" viewBox="0 0 24 24" id="Notification_On" data-name="24x24/On Light/Notification" xmlns="http://www.w3.org/2000/svg">
    ...
    {/* Aleart */}
    <svg width="30px" className={`${props.notifyAlert}`} height="30px" viewBox="0 0 24 24" id="Notification-Alert" data-name="24x24/On Light/Notification-Alert" xmlns="http://www.w3.org/2000/svg">
      <rect id="view-box" width="24" height="24" fill="none"/>
    ...
    {/* Off */}
    <svg width="30px" className={`${props.notifyOff}`} height="30px" viewBox="0 0 24 24" id="Notification-Off" data-name="24x24/On Light/Notification-Off" xmlns="http://www.w3.org/2000/svg">
      <rect id="view-box" width="24" height="24" fill="none"/>
